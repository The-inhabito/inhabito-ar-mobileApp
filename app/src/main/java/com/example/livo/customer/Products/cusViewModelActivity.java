...
public class cusViewModelActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cus_view_model);
        ...
        modelWebView.addJavascriptInterface(new Object() {
            ...
            public String getModelUrl() {
                return modelUrl; // Pass the model URL to the JavaScript
            }
        }, "Android");
